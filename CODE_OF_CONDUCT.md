...
reported by contacting Stephan Heunis at <jsheunis@gmail.com>.
Confidentiality will be respected in reporting.

Stephan Heunis can take any action he deems appropriate
for the safety of the `fMRwhy` community, including but not limited to:
...
* asking a contributor to no longer participate in the development of `fMRwhy`

## Attribution

This Code of Conduct is adapted from the [Contributor Covenant][homepage], version 1.4 (available at https://www.contributor-covenant.org/version/1/4/code-of-conduct.html), and from the Code of Conduct of the `tedana` community (available ar https://github.com/ME-ICA/tedana/blob/master/CODE_OF_CONDUCT.md)

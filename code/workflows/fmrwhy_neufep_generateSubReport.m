function fmrwhy_neufep_generateSubReport(bids_dir, sub)
...
html_template_fn = fullfile(fmrwhy_dir, 'assets', 'fmrwhy_template_subQCreportNEUFEP.htm');
css_template_fn = fullfile(fmrwhy_dir, 'assets', 'fmrwhy_reports.css');

function fmrwhy_util_compareTSNR(tsnr_fns, mask_fn, roi_fns, compare_roi_txt, tsnr_saveAs_fns, perc_saveAs_fns, distr_saveAs_fn)
    ...
    h5 = raincloud_plot('X', tsnr_img{5}(I_mask), 'box_on', 1, 'color', cb(8, :), 'alpha', 0.5, ...
                        'box_dodge', 1, 'box_dodge_amount', 1.0, 'dot_dodge_amount', 1.0, 'box_col_match', 0);
    h6 = raincloud_plot('X', tsnr_img{6}(I_mask), 'box_on', 1, 'color', cb(10, :), 'alpha', 0.5, ...
                        'box_dodge', 1, 'box_dodge_amount', 1.2, 'dot_dodge_amount', 1.2, 'box_col_match', 0);
    legend([h1{1} h2{1} h3{1} h4{1} h5{1} h6{1}], {'Echo 2', 'T2{\ast}-combined', 'tSNR-combined', 'TE-combined', 'rtT2{\ast}-combined', 'rtT2{\ast}'});
    title('tSNR distributions within whole brain mask');
    set(gca, 'XLim', [-10 tsnr_threshold], 'YLim', [-.02 .04]);
    hold(ax1, 'on');
    plot(ax1, [0 0], [0 -0.4], 'k');
    hold(ax1, 'off');
    box off;
    ...
    h4 = raincloud_plot('X', tsnr_img{4}(I_roi{2}), 'box_on', 1, 'color', cb(6, :), 'alpha', 0.5, ...
                        'box_dodge', 1, 'box_dodge_amount', .75, 'dot_dodge_amount', .75, 'box_col_match', 0);
    h5 = raincloud_plot('X', tsnr_img{5}(I_roi{2}), 'box_on', 1, 'color', cb(8, :), 'alpha', 0.5, ...
                        'box_dodge', 1, 'box_dodge_amount', .95, 'dot_dodge_amount', .95, 'box_col_match', 0);
    h6 = raincloud_plot('X', tsnr_img{6}(I_roi{2}), 'box_on', 1, 'color', cb(10, :), 'alpha', 0.5, ...
                        'box_dodge', 1, 'box_dodge_amount', 1.15, 'dot_dodge_amount', 1.15, 'box_col_match', 0);
    legend([h1{1} h2{1} h3{1} h4{1} h5{1} h6{1}], {'Echo 2', 'T2{\ast}-combined', 'tSNR-combined', 'TE-combined', 'rtT2{\ast}-combined', 'rtT2{\ast}'});
    ...
    h3 = raincloud_plot('X', perc_diff{3}(I_roi{1}), 'box_on', 1, 'color', cb(6, :), 'alpha', 0.5, ...
                        'box_dodge', 1, 'box_dodge_amount', .55, 'dot_dodge_amount', .55, 'box_col_match', 0);
    h4 = raincloud_plot('X', perc_diff{4}(I_roi{1}), 'box_on', 1, 'color', cb(8, :), 'alpha', 0.5, ...
                        'box_dodge', 1, 'box_dodge_amount', .75, 'dot_dodge_amount', .75, 'box_col_match', 0);
    h5 = raincloud_plot('X', perc_diff{5}(I_roi{1}), 'box_on', 1, 'color', cb(10, :), 'alpha', 0.5, ...
                        'box_dodge', 1, 'box_dodge_amount', .95, 'dot_dodge_amount', .95, 'box_col_match', 0);
    legend([h1{1} h2{1} h3{1} h4{1} h5{1}], {'T2{\ast}-combined', 'tSNR-combined', 'TE-combined', 'rtT2{\ast}-combined', 'rtT2{\ast}'});
    title(['Percentage difference distributions within ' compare_roi_txt{1}]);
    set(gca, 'XLim', [-100 percentage_threshold], 'YLim', [-.03 .06]);
    hold(ax4, 'on');
    plot(ax4, [0 0], [0 -0.6], 'k');
    hold(ax4, 'off');
    box off;
    ...
    h3 = raincloud_plot('X', perc_diff{3}(I_roi{2}), 'box_on', 1, 'color', cb(6, :), 'alpha', 0.5, ...
                        'box_dodge', 1, 'box_dodge_amount', .55, 'dot_dodge_amount', .55, 'box_col_match', 0);
    h4 = raincloud_plot('X', perc_diff{4}(I_roi{2}), 'box_on', 1, 'color', cb(8, :), 'alpha', 0.5, ...
                        'box_dodge', 1, 'box_dodge_amount', .75, 'dot_dodge_amount', .75, 'box_col_match', 0);
    h5 = raincloud_plot('X', perc_diff{5}(I_roi{2}), 'box_on', 1, 'color', cb(10, :), 'alpha', 0.5, ...
                        'box_dodge', 1, 'box_dodge_amount', .95, 'dot_dodge_amount', .95, 'box_col_match', 0);
    legend([h1{1} h2{1} h3{1} h4{1} h5{1}], {'T2{\ast}-combined', 'tSNR-combined', 'TE-combined', 'rtT2{\ast}-combined', 'rtT2{\ast}'});
    title(['Percentage difference distributions within ' compare_roi_txt{2}]);
    set(gca, 'XLim', [-100 percentage_threshold], 'YLim', [-.03 .06]);
    hold(ax5, 'on');
    plot(ax5, [0 0], [0 -0.6], 'k');
    hold(ax5, 'off');
    box off;

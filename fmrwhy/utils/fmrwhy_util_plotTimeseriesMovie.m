...
im1 = imagesc(ax1, rot90(squeeze(func1{1}(slice_plot,:,:)),rotateVal)); colormap gray
im2 = imagesc(ax2, rot90(squeeze(func2{1}(slice_plot,:,:)),rotateVal)); colormap gray
im3 = imagesc(ax3, rot90(squeeze(func3{1}(slice_plot,:,:)),rotateVal)); colormap gray;
